...
// Rotator
{
    "Rotator", "Rotator", "ECS::Components::Rotator", true,
    [](ComponentUI& ui, nlohmann::json& d) { ui.RenderRotator(d); },
    []() { return nlohmann::json{{"RotationSpeed", 0.0f}, {"RotationOffset", 0.0f}}; },
    COMPONENT_OPS(ECS::Components::Rotator)
},
