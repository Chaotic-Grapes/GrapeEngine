...
namespace Editor::Templates {
        ...
        const std::string& namespaceName)
    {
        return
            ...
            "    {\n"
            "        System.Console.WriteLine(\"System " + className + " initialized\");\n"
            "    }\n\n"
            ...
            "    {\n"
            "        System.Console.WriteLine(\"System " + className + " destroyed\");\n"
            "    }\n"
            "}\n";
    }
        ...
        const std::string& namespaceName)
    {
        return
            ...
            "    public void OnCreate(World world)\n"
            "    {\n"
            "        System.Console.WriteLine(\"Edit-mode system " + className + " initialized\");\n"
            "    }\n\n"
            "    public void OnUpdate(World world, float deltaTime)\n"
            "    {\n"
            ...
            "    public void OnDestroy(World world)\n"
            "    {\n"
            "        System.Console.WriteLine(\"Edit-mode system " + className + " destroyed\");\n"
            "    }\n"
            "}\n";
    }
        ...
        const std::string& namespaceName)
    {
        return
            ...
            "    public void OnCreate(World world)\n"
            "    {\n"
            "        System.Console.WriteLine(\"System " + className + " initialized (counter=\" + _counter + \")\");\n"
            "    }\n\n"
            "    public void OnUpdate(World world, float deltaTime)\n"
            "    {\n"
        ...
        const std::string& namespaceName)
    {
        return
            ...
            "/// </summary>\n"
            "[SystemGroup(SystemGroup.Update)]\n"
            "public class " + className + " : ISystem, ISystemMetadata\n"
            "{\n"
            "    /// <summary>\n"
