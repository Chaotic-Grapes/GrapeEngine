...
{
    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_Clear")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void Clear();

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_WasClicked")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    internal static partial bool WasClicked(ulong entityId, int button);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_WasHoverEntered")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    internal static partial bool WasHoverEntered(ulong entityId);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_WasHoverExited")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    internal static partial bool WasHoverExited(ulong entityId);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_GetEventCount")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial int GetEventCount(ulong entityId);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_GetEvent")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_GetHoveredEntity")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial ulong GetHoveredEntity();

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_UIEvents_IsMouseOverUI")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
