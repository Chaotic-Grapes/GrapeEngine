...
internal static partial class EntityAPI
{
    ...
    //[LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_GetComponent")]
    ...
    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_GetComponentPtr")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static unsafe partial byte* GetComponentPtr(ulong entityId, uint typeHash);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_AddComponent")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.Bool)]
    ...
    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_SetComponent")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static unsafe partial void SetComponent(ulong entityId, uint typeHash, void* componentData, int dataSize);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_HasComponent")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool HasComponent(ulong entityId, uint typeHash);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_RemoveComponent")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void RemoveComponent(ulong entityId, uint typeHash);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_DestroyEntity")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DestroyEntity(ulong entityId);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_CreateEntity")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial ulong CreateEntity();

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_IsAlive")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool IsAlive(ulong entityId);

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_SetWorld")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
