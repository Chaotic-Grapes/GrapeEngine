...
{
    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_Application_Quit")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void Quit();

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_Application_GetName", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial string GetName();

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_Application_GetFixedTimeStep")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial float GetFixedTimeStep();

    [LibraryImport(UnsafeApiHelper.NativeLib, EntryPoint = "ScriptAPI_Application_IsVSyncEnabled")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
