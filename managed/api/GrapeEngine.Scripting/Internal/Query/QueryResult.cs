    ...
    where T1 : unmanaged
{
    ...
    private readonly nint _iteratorPtr;

    internal unsafe QueryResult(Entity entity, T1* c1, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
    ...
    {
        if (_iteratorPtr == nint.Zero)
            return new QueryOptional<TOpt>(nint.Zero);

        uint hash = ComponentTypeHelper.GetTypeHash<TOpt>();
        unsafe
        {
            var iterPtr = (QueryIterator*)_iteratorPtr;
            void* ptr = QueryInteropAPI.QueryGetOptionalComponent(iterPtr, hash);
            return new QueryOptional<TOpt>((nint)ptr);
        }
    }
}
    ...
    where T2 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
    ...
    where T3 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, T3* c3, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
    ...
    where T4 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, T3* c3, T4* c4, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
    ...
    where T : unmanaged
{
    ...
    internal QueryOptional(nint ptr)
    {
        _ptr = ptr;
    }

    public bool HasValue => _ptr != nint.Zero;
    ...
    {
        if (_ptr == nint.Zero) return default;
    ...
    where T5 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, T3* c3, T4* c4, T5* c5, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
    ...
    where T6 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, T3* c3, T4* c4, T5* c5, T6* c6, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
    ...
    where T7 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, T3* c3, T4* c4, T5* c5, T6* c6, T7* c7, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
    ...
    where T8 : unmanaged
{
    ...
    internal unsafe QueryResult(Entity entity, T1* c1, T2* c2, T3* c3, T4* c4, T5* c5, T6* c6, T7* c7, T8* c8, nint iteratorPtr)
    {
        Entity = entity;
        Component1 = ref *c1;
        Component2 = ref *c2;
