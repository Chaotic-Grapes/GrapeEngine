    ...
    where T1 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1> GetEnumerator()
        {
            return new QueryEnumerator<T1>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T2 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T3 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2, T3> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2, T3>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T4 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2, T3, T4> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2, T3, T4>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T5 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2, T3, T4, T5> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2, T3, T4, T5>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T6 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2, T3, T4, T5, T6> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2, T3, T4, T5, T6>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T7 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2, T3, T4, T5, T6, T7> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2, T3, T4, T5, T6, T7>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
    ...
    where T8 : unmanaged
{
    ...
    public struct QueryFilterBuilder
    {
        ...
        public QueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8> GetEnumerator()
        {
            return new QueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8>(_world, _required, [.. _optional], [.. _exclude]);
        }
    }
}
