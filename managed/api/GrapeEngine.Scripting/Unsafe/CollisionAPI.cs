...
{
    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Collision_GetEventCount")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial uint GetEventCount(ulong entityId);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Collision_GetEvent")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    internal static partial bool GetEvent(ulong entityId, uint index, out ulong outOtherEntity, out int outEventType);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Collision_GetEventsBulk")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
