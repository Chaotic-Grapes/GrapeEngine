...
{
    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_LoadCue", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_UnloadCue", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void UnloadCue(string cueId);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_HasCue", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    internal static partial bool HasCue(string cueId);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_Play", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial ulong Play(string cueId, float volume, float pitch, [MarshalAs(UnmanagedType.I1)] bool paused);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_PlaySingle", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial ulong PlaySingle(string cueId, float volume, float pitch, int policy);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_Stop")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void Stop(ulong handleId, int stopMode);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_StopCue", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void StopCue(string cueId, int stopMode);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_IsCuePlaying", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    internal static partial bool IsCuePlaying(string cueId);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_SetInstanceVolume")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void SetInstanceVolume(ulong handleId, float volume);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_SetInstancePitch")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void SetInstancePitch(ulong handleId, float pitch);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_SetInstancePosition")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    ...
    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_SetMasterVolume")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial void SetMasterVolume(float volume);

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_GetMasterVolume")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
    internal static partial float GetMasterVolume();

    [LibraryImport("GrapeEngineNative", EntryPoint = "ScriptAPI_Audio_SetListener")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
